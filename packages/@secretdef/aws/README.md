...
Pre-built [secretdef](https://www.npmjs.com/package/secretdef) definitions for [**AWS**](https://www.npmjs.com/package/@aws-sdk/client-s3) (`@aws-sdk/client-s3`) environment variables.

> This package declares the secrets required by [`@aws-sdk/client-s3`](https://www.npmjs.com/package/@aws-sdk/client-s3). It does **not** install or replace the official SDK — install both side by side.

## Install

```bash
npm install @aws-sdk/client-s3 @secretdef/aws secretdef
```
...
import { secrets as awsSecrets } from '@secretdef/aws';
...
| `AWS_PROFILE` | AWS named profile | No |
...
- [`@aws-sdk/client-s3`](https://www.npmjs.com/package/@aws-sdk/client-s3) — Official AWS SDK
- [AWS on GitHub](https://github.com/aws/aws-sdk-js-v3) — Source
